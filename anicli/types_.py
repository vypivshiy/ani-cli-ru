...
if TYPE_CHECKING:
    from anicli_api.base import BaseSource, BaseSearch, BaseEpisode, BaseOngoing
...
ANICLI_API_ITEM: TypeAlias = Union['BaseSearch', 'BaseOngoing', 'BaseEpisode', 'BaseSource']
